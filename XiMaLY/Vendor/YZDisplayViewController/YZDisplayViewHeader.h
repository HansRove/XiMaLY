...
// 标题滚动视图的高度
static CGFloat const YZTitleScrollViewH = 40;
...
// 默认标题字体
#define YZTitleFont [UIFont systemFontOfSize:14]
...
// 修改标题选择的通知
static NSString * const YZDisplayViewEditingTitleBtnClcikNote = @"YZDisplayViewEditingTitleBtnClcikNote";
